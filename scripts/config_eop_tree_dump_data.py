...
for track_container in [trks_loose_isolated, trks_loose_isolated_vertex, trks_tight_isolated, trks_tight_isolated_vertex]:
        ...
        c.setalg("EoverPTreeAlgo", {"m_name": "EoverP_" + track_container,
                                    ...
                                    "m_energyCalibCommaList": "ClusterEnergy,CellEnergy,LCWClusterEnergy,ClusterEMActiveCalibHitEnergy,ClusterNonEMActiveCalibHitEnergy,ClusterInvisibleActiveCalibHitEnergy,ClusterEscapedActiveCalibHitEnergy,TotalCalibHitEnergy,TotalPhotonBackgroundCalibHitEnergy,TotalHadronicBackgroundCalibHitEnergy",\
