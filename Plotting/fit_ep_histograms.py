...
parser.add_argument("--selection", dest="selection", required=False, default="Inclusive")
args = parser.parse_args()
root_file = args.root_file
selection = args.selection

balance_fitter = ROOT.JES_BalanceFitter()
hm = histogram_manager.HistogramManager(args.root_file)
tf = ROOT.TFile(args.root_file, "READ")
tf.ls()
binnings = get_binning(tf, selection)
print("These were the binnings {}".format(binnings))
