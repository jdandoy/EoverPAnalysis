...
import os
import time
from CommonPlots.CommonPlots import CreateZeroFractionPlotsFromSelection, CreatePlotsFromSelection
...
CreatePlotsFromSelection(HM,"MIPSelectionHadFracAbove70", filename, base_description = base_description + ["MIP Selection"],doFit = True ,fitfunction="convolution", refit=False)
