...
leading_script.write("transfer_input_files    = CondorPythonLocal, PlottingTools, variables, HistogramFillingTools, selections, condorSubmission/submit.py ,calculation, FillingScript.py, " + submission_pickle_file + "\n")
