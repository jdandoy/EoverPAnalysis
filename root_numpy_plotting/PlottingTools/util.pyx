...
cpdef  np.ndarray[FLOATDTYPE_t, ndim =1] getWeightsFromBins(float_or_int_array variable_in_histogram, float_or_int_array low_edges, float_or_int_array high_edges, np.ndarray[FLOATDTYPE_t, ndim = 1] normalization):
